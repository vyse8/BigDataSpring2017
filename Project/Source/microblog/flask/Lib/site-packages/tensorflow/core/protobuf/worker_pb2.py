...
_DEREGISTERGRAPHREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='graph_handle', full_name='tensorflow.DeregisterGraphRequest.graph_handle', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RUNGRAPHREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='graph_handle', full_name='tensorflow.RunGraphRequest.graph_handle', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='step_id', full_name='tensorflow.RunGraphRequest.step_id', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='exec_opts', full_name='tensorflow.RunGraphRequest.exec_opts', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='send', full_name='tensorflow.RunGraphRequest.send', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='recv_key', full_name='tensorflow.RunGraphRequest.recv_key', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_partial', full_name='tensorflow.RunGraphRequest.is_partial', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='is_last_partial_run', full_name='tensorflow.RunGraphRequest.is_last_partial_run', index=6,
